...
Ο κόσμος είναι βασισμένος σε μια βάσικη κλάση Grid η οποία έχει ως member τα αντικείμενα του κόσμου.
Επιπλέον υπάρχει το struct Position το οποίο χρεισημοποιήται για την αποθήκευση των συντεταγμένων των 
